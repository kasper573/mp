  ...
  RedisSetSync.createEffect(
    {
      ...
      // Cast is safe: only .get()/.subscribe() are used (save, synchronize, heartbeat methods)
      signal: onlineCharacterIds as Signal<ReadonlySet<CharacterId>>,
      ...
      if (willRouterAcceptMessage(gatewayRouter, result.value)) {
        gatewayEventInvoker.addEvent(
          ...
          ioc
            ...
            .provide(ctxUserSessionSignal, session as unknown as Signal<UserSession>)
