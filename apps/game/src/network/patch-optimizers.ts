...
import type { SyncComponentPropertyOptions } from "@mp/sync";

export const coords: SyncComponentPropertyOptions<Vector<Tile>> = {
...
export const path: SyncComponentPropertyOptions<Path<Tile> | undefined> = {
