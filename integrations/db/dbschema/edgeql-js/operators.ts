...
interface infixOperandsBaseType<LHS extends _.castMaps.orScalarLiteral<$.TypeSet<$.BaseType>>> {
  lhs: LHS;
  rhs: _.castMaps.orScalarLiteral<$.TypeSet<$.getPrimitiveBaseType<_.castMaps.literalToTypeSet<LHS>["__element__"]>>>;
}

interface infixOperandsRangeType<LHS extends $.TypeSet<$.RangeType<_std.$anypoint>>> {
  lhs: LHS;
  rhs: $.TypeSet<$.RangeType<$.getPrimitiveBaseType<LHS["__element__"]["__element__"]>>>;
}

interface infixOperandsMultiRangeType<LHS extends $.TypeSet<$.MultiRangeType<_std.$anypoint>>> {
  lhs: LHS;
  rhs: $.TypeSet<$.MultiRangeType<$.getPrimitiveBaseType<LHS["__element__"]["__element__"]>>>;
}

interface infixOperandsArrayTypeNonArray<LHS extends $.TypeSet<$.ArrayType<$.NonArrayType>>> {
  lhs: LHS;
  rhs: $.TypeSet<$.ArrayType<$.getPrimitiveNonArrayBaseType<LHS["__element__"]["__element__"]>>>;
}
...
interface InfixBooleanMultiplyOperators {
  "=": 
    ...
    | { lhs: _.castMaps.orScalarLiteral<$.TypeSet<$.EnumType>>, rhs: _.castMaps.orScalarLiteral<$.TypeSet<$.EnumType>> }
    ...
    | { lhs: $.TypeSet<$.ArrayType<$.AnyTupleType>>; rhs: $.TypeSet<$.ArrayType<$.AnyTupleType>> }
    ...
    | { lhs: _.castMaps.orScalarLiteral<$.TypeSet<_std.$datetime>>, rhs: _.castMaps.orScalarLiteral<$.TypeSet<_std.$datetime>> }
    | { lhs: _.castMaps.orScalarLiteral<$.TypeSet<_std.$duration>>, rhs: _.castMaps.orScalarLiteral<$.TypeSet<_std.$duration>> }
    ...
    | { lhs: _.castMaps.orScalarLiteral<$.TypeSet<_std.$uuid>>, rhs: _.castMaps.orScalarLiteral<$.TypeSet<_std.$uuid>> }
    ...
    | { lhs: _.castMaps.orScalarLiteral<$.TypeSet<_cfg.$memory>>, rhs: _.castMaps.orScalarLiteral<$.TypeSet<_cfg.$memory>> }
    | { lhs: _.castMaps.orScalarLiteral<$.TypeSet<_stdcal.$local_date>>, rhs: _.castMaps.orScalarLiteral<$.TypeSet<_stdcal.$local_date>> }
    | { lhs: _.castMaps.orScalarLiteral<$.TypeSet<_stdcal.$local_time>>, rhs: _.castMaps.orScalarLiteral<$.TypeSet<_stdcal.$local_time>> }
    | { lhs: _.castMaps.orScalarLiteral<$.TypeSet<_std.$decimalλICastableTo>>, rhs: _.castMaps.orScalarLiteral<$.TypeSet<_std.$anyint>> }
  ...
  ">=": 
    ...
    | { lhs: _.castMaps.orScalarLiteral<$.TypeSet<_stdcal.$local_date>>, rhs: _.castMaps.orScalarLiteral<$.TypeSet<_stdcal.$local_date>> }
    | { lhs: _.castMaps.orScalarLiteral<$.TypeSet<_stdcal.$local_time>>, rhs: _.castMaps.orScalarLiteral<$.TypeSet<_stdcal.$local_time>> }
    | { lhs: _.castMaps.orScalarLiteral<$.TypeSet<_std.$anyint>>, rhs: _.castMaps.orScalarLiteral<$.TypeSet<_std.$decimalλICastableTo>> }
    | { lhs: _.castMaps.orScalarLiteral<$.TypeSet<_std.$decimalλICastableTo>>, rhs: _.castMaps.orScalarLiteral<$.TypeSet<_std.$decimalλICastableTo>> }
    | { lhs: _.castMaps.orScalarLiteral<$.TypeSet<_stdcal.$local_datetimeλICastableTo>>, rhs: _.castMaps.orScalarLiteral<$.TypeSet<_stdcal.$local_datetimeλICastableTo>> }
    | { lhs: _.castMaps.orScalarLiteral<$.TypeSet<_stdcal.$relative_durationλICastableTo>>, rhs: _.castMaps.orScalarLiteral<$.TypeSet<_stdcal.$relative_durationλICastableTo>> }
  ">": 
...
interface InfixBooleanMultiplyOneOperators {
  "in": 
    ...
    | { lhs: $.TypeSet<_std.$decimalλICastableTo>; rhs: $.TypeSet<_std.$decimalλICastableTo> }
    | { lhs: $.TypeSet<$.ArrayType<_stdcal.$relative_durationλICastableTo>>; rhs: $.TypeSet<$.ArrayType<_stdcal.$relative_durationλICastableTo>> }
    | { lhs: $.TypeSet<$.ArrayType<_stdcal.$local_datetimeλICastableTo>>; rhs: $.TypeSet<$.ArrayType<_stdcal.$local_datetimeλICastableTo>> }
    | { lhs: $.TypeSet<$.ArrayType<_std.$decimalλICastableTo>>; rhs: $.TypeSet<$.ArrayType<_std.$decimalλICastableTo>> }
    | { lhs: $.TypeSet<$.ObjectType>; rhs: $.TypeSet<$.ObjectType> }
...
interface InfixScalarMultiplyOperators {
  "+": 
    ...
    | { lhs: _.castMaps.orScalarLiteral<$.TypeSet<_std.$duration>>; rhs: _.castMaps.orScalarLiteral<$.TypeSet<_std.$duration>> }
    | { lhs: _.castMaps.orScalarLiteral<$.TypeSet<_stdcal.$local_date>>; rhs: _.castMaps.orScalarLiteral<$.TypeSet<_std.$duration>> }
    | { lhs: _.castMaps.orScalarLiteral<$.TypeSet<_stdcal.$local_date>>; rhs: _.castMaps.orScalarLiteral<$.TypeSet<_stdcal.$date_duration>> }
    | { lhs: _.castMaps.orScalarLiteral<$.TypeSet<_stdcal.$local_time>>; rhs: _.castMaps.orScalarLiteral<$.TypeSet<_std.$duration>> }
    | { lhs: _.castMaps.orScalarLiteral<$.TypeSet<_stdcal.$date_duration>>; rhs: _.castMaps.orScalarLiteral<$.TypeSet<_stdcal.$date_duration>> }
    | { lhs: _.castMaps.orScalarLiteral<$.TypeSet<_std.$datetime>>; rhs: _.castMaps.orScalarLiteral<$.TypeSet<_stdcal.$relative_durationλICastableTo>> }
    | { lhs: _.castMaps.orScalarLiteral<$.TypeSet<_stdcal.$local_date>>; rhs: _.castMaps.orScalarLiteral<$.TypeSet<_stdcal.$relative_durationλICastableTo>> }
    | { lhs: _.castMaps.orScalarLiteral<$.TypeSet<_stdcal.$local_time>>; rhs: _.castMaps.orScalarLiteral<$.TypeSet<_stdcal.$relative_durationλICastableTo>> }
    | { lhs: _.castMaps.orScalarLiteral<$.TypeSet<_std.$duration>>; rhs: _.castMaps.orScalarLiteral<$.TypeSet<_stdcal.$relative_durationλICastableTo>> }
    | { lhs: _.castMaps.orScalarLiteral<$.TypeSet<_stdcal.$local_datetimeλICastableTo>>; rhs: _.castMaps.orScalarLiteral<$.TypeSet<_std.$duration>> }
    | { lhs: _.castMaps.orScalarLiteral<$.TypeSet<_std.$decimalλICastableTo>>; rhs: _.castMaps.orScalarLiteral<$.TypeSet<_std.$decimalλICastableTo>> }
...
type ExtractRHS<T, LHS> =
  T extends { lhs: infer LHSType; rhs: infer RHSType } ? LHS extends LHSType ? RHSType : never : never;
...
function op<
  ...
  Card extends $.cardutil.multiplyCardinalities<$.cardutil.paramCardinality<LHS>, $.cardutil.paramCardinality<RHS>>,
...
function op<
  ...
  Element extends _std.$bool,
  Card extends $.cardutil.multiplyCardinalities<$.cardutil.optionalParamCardinality<LHS>, $.cardutil.optionalParamCardinality<RHS>>
>(lhs: LHS, op: Op, rhs: RHS): $.$expr_Operator<Element, Card>;
...
function op<
  ...
  Element extends _std.$bool,
  Card extends $.cardutil.multiplyCardinalities<$.cardutil.paramCardinality<LHS>, $.Cardinality.One>
>(lhs: LHS, op: Op, rhs: RHS): $.$expr_Operator<Element, Card>;

function op<
  Op extends keyof PrefixBooleanOperators,
  Operand extends PrefixBooleanOperators[Op]["operand"],
>(op: Op, operand: Operand): $.$expr_Operator<_std.$bool, $.cardutil.paramCardinality<Operand>>;
...
function op<
  ...
  Element extends $.getPrimitiveBaseType<_.castMaps.literalToTypeSet<LHS>["__element__"]>,
  Card extends $.cardutil.multiplyCardinalities<$.cardutil.paramCardinality<LHS>, $.cardutil.paramCardinality<RHS>>,
>(lhs: LHS, op: Op, rhs: RHS): $.$expr_Operator<Element, Card>;
...
function op<
  ...
  Element extends $.getPrimitiveBaseType<_.castMaps.literalToTypeSet<LHS>["__element__"]>,
  Card extends $.cardutil.coalesceCardinalities<$.cardutil.paramCardinality<LHS>, $.cardutil.paramCardinality<RHS>>
>(lhs: LHS, op: Op, rhs: RHS): $.$expr_Operator<Element, Card>;
...
function op<
  ...
  Element extends _.syntax.getSharedParentPrimitive<LHS["__element__"], RHS["__element__"]>,
  Card extends $.cardutil.coalesceCardinalities<$.cardutil.paramCardinality<LHS>, $.cardutil.paramCardinality<RHS>>
>(lhs: LHS, op: Op, rhs: RHS): $.$expr_Operator<Element, Card>;
...
function op<
  ...
  Element extends _.syntax.mergeObjectTypes<LHS["__element__"], RHS["__element__"]>,
  Card extends $.cardutil.coalesceCardinalities<$.cardutil.paramCardinality<LHS>, $.cardutil.paramCardinality<RHS>>
>(lhs: LHS, op: Op, rhs: RHS): $.$expr_Operator<Element, Card>;
...
function op<
  ...
  Element extends $.RangeType<$.getPrimitiveBaseType<LHS["__element__"]["__element__"]>>,
  Card extends $.cardutil.multiplyCardinalities<$.cardutil.paramCardinality<LHS>, $.cardutil.paramCardinality<RHS>>
>(lhs: LHS, op: Op, rhs: RHS): $.$expr_Operator<Element, Card>;
...
function op<
  ...
  Element extends $.MultiRangeType<$.getPrimitiveBaseType<LHS["__element__"]["__element__"]>>,
  Card extends $.cardutil.multiplyCardinalities<$.cardutil.paramCardinality<LHS>, $.cardutil.paramCardinality<RHS>>
>(lhs: LHS, op: Op, rhs: RHS): $.$expr_Operator<Element, Card>;
...
function op<
  ...
  Element extends $.ArrayType<_.syntax.getSharedParentPrimitive<LHS["__element__"]["__element__"], RHS["__element__"]["__element__"]>>,
  Card extends $.cardutil.multiplyCardinalities<$.cardutil.paramCardinality<LHS>, $.cardutil.paramCardinality<RHS>>
>(lhs: LHS, op: Op, rhs: RHS): $.$expr_Operator<Element, Card>;
...
function op<
  ...
  Element extends $.ArrayType<_.syntax.mergeObjectTypes<LHS["__element__"]["__element__"], RHS["__element__"]["__element__"]>>,
  Card extends $.cardutil.multiplyCardinalities<$.cardutil.paramCardinality<LHS>, $.cardutil.paramCardinality<RHS>>
>(lhs: LHS, op: Op, rhs: RHS): $.$expr_Operator<Element, Card>;
...
function op<
  ...
  Element extends $.getPrimitiveBaseType<_.castMaps.literalToTypeSet<LHS>["__element__"]>,
  Card extends $.cardutil.mergeCardinalities<$.cardutil.paramCardinality<LHS>, $.cardutil.paramCardinality<RHS>>
>(lhs: LHS, op: Op, rhs: RHS): $.$expr_Operator<Element, Card>;
...
>(lhs: LHS, op1: "if", cond: Cond, op2: "else", rhs: RHS): $.$expr_Operator<
  _.syntax.getSharedParentPrimitive<LHS["__element__"], RHS["__element__"]>,
  $.cardutil.multiplyCardinalities<$.cardutil.orCardinalities<$.cardutil.paramCardinality<LHS> , $.cardutil.paramCardinality<RHS>>, $.cardutil.paramCardinality<Cond>>
>;
function op<
  Cond extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$bool>>,
  LHS extends TernaryContainerOperators["if_else"]["lhs"],
  RHS extends ExtractRHS<TernaryContainerOperators["if_else"], LHS>,
>(op1: "if", cond: Cond, op2: "then", lhs: LHS, op3: "else", rhs: RHS): $.$expr_Operator<
  _.syntax.getSharedParentPrimitive<LHS["__element__"], RHS["__element__"]>,
  $.cardutil.multiplyCardinalities<$.cardutil.orCardinalities<$.cardutil.paramCardinality<LHS> , $.cardutil.paramCardinality<RHS>>, $.cardutil.paramCardinality<Cond>>
>;
