...
export type $date_duration = $.ScalarType<"std::cal::date_duration", _.gel.DateDuration>;
...
export type $relative_duration = $.ScalarType<"std::cal::relative_duration", _.gel.RelativeDuration>;
...
function to_local_datetime(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::cal::to_local_datetime', args, _.spec, [
...
function to_local_date(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::cal::to_local_date', args, _.spec, [
...
function to_relative_duration(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::cal::to_relative_duration', args, _.spec, [
...
function to_date_duration(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::cal::to_date_duration', args, _.spec, [
...
function time_get(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::cal::time_get', args, _.spec, [
...
function date_get(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::cal::date_get', args, _.spec, [
...
function duration_normalize_hours(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::cal::duration_normalize_hours', args, _.spec, [
...
function duration_normalize_days(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::cal::duration_normalize_days', args, _.spec, [
